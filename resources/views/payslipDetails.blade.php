    ...
    <div style="width:750px; height:1200px; margin: 0 auto; border:1px solid gray; background-color: white; padding: 30px;">
      ...
      <table width="100%" style="border:1px solid gray;">
        <tbody><tr>
          ...
          <td width="40%">
            <input value="{{($employee->idNumber)}}" required name="employeeID" id="post-title" class="form-control form-control-lg form-control-title" type="text" placeholder="1010-4-0030" autocomplete="off" />
          </td>
          <th align="left" width="15%">
            Job Title:
          </th>
          <td width="35%">
            <input required value="{{($employee->job)}}" name="post" id="post-title" class="form-control form-control-lg form-control-title" type="text" placeholder="Job Title Here" autocomplete="off" />
          </td>
        </tr>
        <tr>
          <th align="left"> 
          ...
          <td>
            <input value="{{($employee->name)}}" required name="name" id="post-title" class="form-control form-control-lg form-control-title" type="text" placeholder="Nitish Jeebun" autocomplete="off" />
          </td>
          <th align="left">
            Dept.:
          </th>
          <td>
            <input value="{{($employee->department)}}" required name="department" id="post-title" class="form-control form-control-lg form-control-title" type="text" placeholder="Development" autocomplete="off" />
          </td>
        </tr>
        <tr>
          <th align="left"> 
      ...
      <table width="100%" class="sections" cellspacing="0">
        ...
        <tr>
          ...
          <td align="right">
                ...
                <input value="{{($employee->salary) / 2}}" required name="Salary" id="Salary" type="number" min="0" type="submit" /> 
