  ...
  <div style="width:750px; height:1200px; margin: 0 auto; border:1px solid gray; background-color: white; padding: 30px;">
    ...
    <table width="100%" style="border:1px solid gray;">
      <tbody><tr>
        ...
        <td width="40%">
          <input value="{{($employee->idNumber)}}" required name="employeeID" id="post-title" class="form-control form-control-lg form-control-title" type="text"/>
        </td>
        <th align="left" width="15%">
          Job Title:
        </th>
        <td width="35%">
          <input required value="{{($employee->job)}}" name="job" id="post-title" class="form-control form-control-lg form-control-title" type="text"/>
        </td>
      </tr>
      <tr>
        <th align="left"> 
        ...
        <td>
          <input value="{{($employee->name)}}" required name="name" id="post-title" class="form-control form-control-lg form-control-title" type="text"/>
        </td>
        <th align="left">
          Dept.:
        </th>
        <td>
          <input value="{{($employee->department)}}" required name="department" id="post-title" class="form-control form-control-lg form-control-title" type="text"/>
        </td>
      </tr>
      <tr>
        <th align="left"> 
        ...
        <td>
          <input required name="bankAccount" id="post-title" class="form-control form-control-lg form-control-title" type="text"/>
    ...
    <table width="100%" class="sections" cellspacing="0">
      ...
      <tr>
        ...
        <td align="right">
              ...
              <input value="{{($employee->salary) / 2}}" required name="salary" id="Salary" type="number" min="0"/> 
      ...
      <tr>
        ...
        <td align="right"></td>
        <td align="right">
          <input required name="pagibig" id="Pag-ibig" type="number" min="0"/>
        </td>
      </tr>
      <tr>
        <td></td>
      ...
      <tr>
        ...
        <td align="right"><div style="border-bottom:1px solid gray;padding-bottom: 3px;">
              <b> {{($employee->salary) + ($employee->idNumber)}} </b>
          </div>
        </td>
        <td align="right">
